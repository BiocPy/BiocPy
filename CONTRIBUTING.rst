...
Welcome to ``BiocPy`` contributor's guide.
...
If you experience bugs or general issues with ``BiocPy``, please have a look
...
You can help improve ``BiocPy`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``BiocPy`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``BiocPy``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n BiocPy python=3 six virtualenv pytest pytest-cov
    conda activate BiocPy
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/BiocPy.git
    cd BiocPy
...
#. Install |pre-commit|_::
   ...
   ``BiocPy`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/BiocPy
.. _issue tracker: https://github.com/<USERNAME>/BiocPy/issues
.. <-- end -->
